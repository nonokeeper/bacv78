$('#exampleModal').on('show.bs.modal', function (event) {
    ...
    let modal = $(this);
    modal.find('.modal-title').text('Modifier votre mot de passe ' + recipient);
...
// Gestion de la notif avec bouton Créer spécifique selon l'envoi ou non
$('.showRecipients').click(function(){
  var checked = $('#article_notif').is(":checked");
  if (checked) {
...
// Si envoi confirmé, le formulaire Article est soumis : Article créé et Notif Email envoyée
