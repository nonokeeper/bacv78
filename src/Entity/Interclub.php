 ...
 * @APIResource
 * @ApiFilter(SearchFilter::class, properties={"teamBACV": "exact", "saison": "exact"})
 */
class Interclub
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Team", inversedBy="interclubs")
     * @Groups({"interclub:read"})
     */
    private $teamBACV;
    ...
    */
    ...
    public function setTeamHome(?Team $teamHome): self
    {
        ...
        } else if($this->teamHome->getClub()->getSlug() == 'BACV')
            $this->setTeamBACV($teamHome);
    ...
    public function setTeamExt(?Team $teamExt): self
    {
        ...
        if($this->teamExt)
            if ($this->teamExt->getClub()->getSlug() == 'BACV')
                $this->setTeamBACV($teamExt);
    ...
    {
        return $this->getTeamBACV()->getMixte();
    }
