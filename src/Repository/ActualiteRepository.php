...
class ActualiteRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function findLastOne(): ?Actualite
    {
        return $this->createQueryBuilder('a')
            ->andWhere ('a.startDate < :current')
            ->andWhere ('a.endDate > :current')
            ->setParameter('current', new \DateTime('now', new \DateTimeZone('Europe/Paris')))
            ->setMaxResults(1)
            ->getQuery()
            ->getOneOrNullResult();
    }
